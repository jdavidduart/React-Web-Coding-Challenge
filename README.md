...
- [ OK] I want to see a list of reported bike thefts for the Berlin area.
- [OK ] I want to see the first 10 bike theft cases, with the ability to - paginate (10 cases per page).
- [ OK] I want to see a total number of bike theft cases.
- [ OK] For each reported bike theft I want to see:
  - [ OK] Case title
  - [ OK] Case description
  - [ OK] Date of the theft
  - [ OK] Date of when the case was reported
  - [ OK] Location of the theft
  - [ OK] Picture of the bike, if available
- [ OK] I want to filter reported bike thefts by partial case title.
- [ OK] I want to filter reported bike thefts by date range.
- [ OK] I want to see a loading state until the list is available.
- [ OK] I want to see an error state if the list is unavailable.
